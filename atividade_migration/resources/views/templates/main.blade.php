...
<html lang="pt-br">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-blue" style="background-color:blue">
            <div class="container-fluid">
                <a href="{{route('index')}}" class="navbar-brand ms-sm-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#FFF" class="bi bi-clipboard2-pulse-fill" viewBox="0 0 16 16">
                    ...
                    <span class="ps-1 text-white">VetClin</span>
                </a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown ps-2">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="{{route('veterinarios.index')}}">Veterinarios</a></li>
                                <li><a class="dropdown-item" href="{{route('especialidades.index')}}">Especialidades</a></li>
                            </ul>
                        </li>
        ...
        <nav class="navbar fixed-bottom navbar-blue bg-primary">
            <div class="container-fluid">
                <span class="text-white fw-blue">&copy; italo</span>
            </div>
        </nav>
    </body>
    ...
    <script src="{{ asset('js/jquery-3.7.0') }}"></script>
